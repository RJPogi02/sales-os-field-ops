...
export function ProfileSendPack({ lead, operatorName, onUpdateLead, onMarkSent }) {
  const [copied, setCopied] = useState('')
  const pack = useMemo(() => buildProfileEmail(lead, operatorName), [lead, operatorName])
  ...
  return (
    <section className="profile-send-pack">
      ...
      <div className="attachment-reminder"><Paperclip size={17} /><div><strong>Attachment check</strong><span>Attach the demo company profile before sending.</span></div></div>
